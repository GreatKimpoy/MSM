      ...
      <nav class="mt-2">
         ...
         <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <div>
                  ...
                  <ul class="nav nav-treeview">
                        <li class="nav-item">
                          <a href="/admin/maintenance/category/categories" class="nav-link">
                            <i class="nav-icon fa plus-square"></i>
                        ...
                        <li class="nav-item">
                          <a href="/admin/maintenance/service/services" class="nav-link">
                            <i class="nav-icon fa plus-square"></i>
                            <i class="fa fa-circle-o nav-icon"></i>
                            <p>Service</p>
                         </a>
                        ...
                        <li class="nav-item">
                          <a href="/admin/maintenance/mechanic/mechanics" class="nav-link">
                            <i class="nav-icon fa plus-square"></i>
                            <i class="fa fa-circle-o nav-icon"></i>
                            <p>Technician</p>
                         </a>
