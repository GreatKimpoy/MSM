...
<div class = "form">
	...
	<div class="row">
		<div class="col-md-6">
			<label for="vehicle" class="labely">Vehicle Make<span class="asterisks"><strong>*</strong></span></label>
			<div class="input-group">
				<div class="input-group-prepend">
		...
		<div class="col-md-6">
			<label for="vehicle" class="labely">Vehicle Model<span class="asterisks"><strong>*</strong></span></label>
			<div class="input-group">
				<div class="input-group-prepend">
